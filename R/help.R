...
samples."),
  ...
  (e.g. genes, isoforms, miRNAs, ATAC or Chip regions etc.)."),
    p(
      "If you do not have a dataset to upload, you can use the built in demo data file by
...
getDataAssesmentText <- function() {
  list(
   ...
   than defined threshold."),
    ...
    p(
      "If specified metadata file containing your treatment and batch fields, by clicking ",
...
getDataPreparationText <- function() {
  list(
    ...
    p(
      "1. Read counts for each sample.", br(),
...
and analysis tools to help visualize your data even further."
    ...
    p(
      "If you are ready to discover and visualize your data, please click ",
